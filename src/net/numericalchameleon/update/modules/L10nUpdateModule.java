...
public class L10nUpdateModule extends AbstractUpdateModule {

    public final static String LATEST_KNOWN_VERSION_PROPERTY_NAME = "latest_known_l10n_version";
    public final static String LATEST_KNOWN_VERSION_VALUE = "20180826";
    
    public L10nUpdateModule() {
        name = "Localization";
        vendor = "NC Translators";
