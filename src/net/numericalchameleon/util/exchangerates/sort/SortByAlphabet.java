...
public class SortByAlphabet extends SortItem implements SortAction {

    private final ArrayList<ExchangeRatesFilter> filters;

    public SortByAlphabet(ArrayList<ExchangeRatesFilter> filters, String id, String iconCode, String i18nID) {
