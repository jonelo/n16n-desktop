...
public class SortByQuantity extends SortItem implements SortAction {

    private final ArrayList<ExchangeRatesFilter> filters;

    public SortByQuantity(ArrayList<ExchangeRatesFilter> filters, String id, String iconCode, String i18nID) {
    ...
    public void sort() {
        Collections.sort(filters, (ExchangeRatesFilter filter1, ExchangeRatesFilter filter2) -> {
            //System.out.println("Comparing" + filter1.getName() + " with " + filter2.getName());
            try {
